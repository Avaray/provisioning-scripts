...
# Auto-generated provisioning script for Juggernaut_X_RunDiffusion (Forge UI - Standard)
# Generated at 2026-05-06T21:19:02.796Z
...
echo "=== Starting Provisioning for Juggernaut_X_RunDiffusion ==="

# --- Base Model ---
download_file "https://huggingface.co/datasets/AddictiveFuture/sdxl-1-0-models-backup/resolve/main/CHECKPOINT/Juggernaut_X_RunDiffusion.safetensors" "/workspace/stable-diffusion-webui-forge/models/Stable-diffusion"
