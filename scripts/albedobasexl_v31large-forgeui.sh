...
# Auto-generated provisioning script for albedobase (Forge UI - Standard)
# Generated at 2026-05-07T21:11:05.036Z
...
echo "=== Starting Provisioning for albedobase ==="

# --- Base Checkpoint ---
download_file "https://huggingface.co/datasets/AddictiveFuture/sdxl-1-0-models-backup/resolve/main/CHECKPOINT/albedobaseXL_v31Large.safetensors" "/workspace/stable-diffusion-webui-forge/models/Stable-diffusion"
