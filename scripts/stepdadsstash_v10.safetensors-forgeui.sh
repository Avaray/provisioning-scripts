...
# Auto-generated provisioning script for stepDadsStash (Forge UI - Standard)
# Generated at 2026-05-06T21:24:11.695Z
...
echo "=== Starting Provisioning for stepDadsStash ==="

# --- Base Model ---
download_file "https://huggingface.co/datasets/AddictiveFuture/sdxl-1-0-models-backup/resolve/main/CHECKPOINT/stepDadsStash_v10.safetensors" "/workspace/stable-diffusion-webui-forge/models/Stable-diffusion"
