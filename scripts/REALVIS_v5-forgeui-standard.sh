...
# Auto-generated provisioning script for REALVIS v5 (Forge UI - Standard)
# Generated at 2026-05-06T14:04:33.284Z
...
echo "=== Starting Provisioning for REALVIS v5 ==="

# --- Base Model ---
download_file "https://huggingface.co/datasets/AddictiveFuture/sdxl-1-0-models-backup/resolve/main/CHECKPOINT/realvisxlV50_v50Bakedvae.safetensors" "/workspace/stable-diffusion-webui-forge/models/Stable-diffusion"
